...
public class QuizActivity extends AppCompatActivity {
    ...
    private Button btnDapAnA, btnDapAnB, btnDapAnC, btnDapAnD, btnBack, btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener listener = v -> kiemTraDapAn((Button) v);
        btnDapAnA.setOnClickListener(listener);
        btnDapAnB.setOnClickListener(listener);
        btnDapAnC.setOnClickListener(listener);
        btnDapAnD.setOnClickListener(listener);
    ...
    private void hienThiCauHoi() {
        ...
        tvCauHoiNum.setText(String.format(Locale.getDefault(), "Câu hỏi %d/%d", (indexHienTai + 1), danhSachCauHoi.size()));
        tvCauHoiNum.setTextColor(themeColor);
        ...
        for(int i = 0; i < 4; i++) {
            ...
            btns[i].setEnabled(trangThaiCauHoi[indexHienTai] == 0);
    ...
    private void kiemTraDapAn(Button btn) {
        ...
        new Handler().postDelayed(this::kiemTraChuyenCau, 400);
    }
    ...
    private void kiemTraChuyenCau() {
        ...
        if (allAnswered) {
            ...
            if (indexHienTai < danhSachCauHoi.size() - 1) {
                ...
                hienThiCauHoi();
                Toast.makeText(QuizActivity.this, "Bạn còn câu chưa hoàn thành!", Toast.LENGTH_SHORT).show();
            }
        }
    }
